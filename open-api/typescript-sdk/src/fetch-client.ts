 ...
 */
export function generateHighlightFromAlbum(
  {
...
export function deleteHighlight(
  ...
  return oazapfts.ok(
    oazapfts.fetchText(`/highlights/${encodeURIComponent(id)}`, {
      ...opts,
      method: 'DELETE',
    }),
  );
 ...
 */
export function removeHighlightAssets(
  {
    id,
    bulkIdsDto,
  }: {
  ...
  return oazapfts.ok(
    oazapfts.fetchJson<{
      ...
      `/highlights/${encodeURIComponent(id)}/assets`,
      oazapfts.json({
        ...opts,
        method: 'DELETE',
        body: bulkIdsDto,
 ...
 */
export function addHighlightAssets(
  {
    id,
    bulkIdsDto,
  }: {
